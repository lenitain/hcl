...
- 状态：Task 5 完成（from_hcl_with_body_schema API）
...
| 9 | **Schema 驱动的 body 提取** | 🔄 Task 4 完成：Block 提取（递归 body、标签验证、max_items）。待实现：from_hcl_with_body_schema API（Task 5）。 |
