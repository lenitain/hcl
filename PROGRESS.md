...
## 当前分支
- 分支：`lenitain/feat/single-library-hcl`
- 状态：开发完成
- 目标：实现"单一库包揽hcl"目标

## 本次开发完成的功能
- ✅ 代码质量改进：修复 deprecated 警告（has_prefix/has_suffix、!x、length()）
- ✅ 所有 548 个测试通过
- ✅ moon check: 0 errors
- ✅ moon fmt: 通过
- ✅ moon info: 生成成功
...
## 本次开发完成的功能
- ✅ CLI 参数解析（--help, --pretty, --simplify, --file）
- ✅ CLI --validate 选项（验证 HCL 可解析性）
- ✅ CLI --format 选项（输出格式化 HCL）
- ✅ 所有高优先级改进项已完成
- ✅ 所有 548 个测试通过
